...
function HousingCategorie(){
    const [categorie,setCategorie]=useState([
        ...
        {name:"Taxes",nameIcon:"assignment",color:"#1DAED9",key:'3'},
    ]);
    return(
    ...
    height:40, 
    backgroundColor:"#1DAED9",
    borderRadius:40,
  justifyContent:'center',
  alignItems:'center',
  marginTop:10,
  
}} ><FontAwesome name="home" size={27} color="white"/></View></View>
               <View style={styles.general}>  
                <Text style={styles.name}>Housing</Text></View>
...
export default HousingCategorie;